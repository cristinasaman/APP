...
class CameraActor:
    def __init__(self, camera: str, zone_id: str, dispatcher_mailbox_name: str, frame_size: int, capture_interval: float, max_frames: int): # Added max_frames from previous suggestion, let's make sure it's included if used
        """
